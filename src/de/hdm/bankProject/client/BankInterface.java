...
public class BankInterface implements ActionListener, TreeSelectionListener {
	...
	/**
	 * Erzeugen der sichtbaren Komponenten. Das Hauptfenster wird in drei Teile fuer
	 * den Kunden-und-Konten-Baum, die Kundenangaben und die Kontoangaben
	 * unterteilt. Zusaetzlich wird die Menue- Erzeugung angestossen.
	 *
	 */
	void generateComponents() {
		...
		/*
		 * Fuer den Kunden-und-Konten-Baum wird zunaechst die sichtbare Komponente
		 * erzeugt. Danach wird diese mit den Inhalten erzeugt, die vom
	...
	/**
	 * Das Setzen des ausgewaehlten Kunden wird an die Unterkomponenten
	 * weitergereicht.
	 * 
	 * @param c
	 */
	...
	/**
	 * Das Entfernen des ausgewaehlten Kunden wird an die Unterkomponenten
	 * weitergereicht.
	 */
	...
	/**
	 * Das Setzen des ausgewaehlten Kontos wird an die Unterkomponente
	 * weitergereicht.
	 * 
	 * @param a
	 */
	...
	/**
	 * Das Loeschen des ausgewaehlten Kontos wird an die Unterkomponente
	 * weitergereicht.
	 */
	...
	/**
	 * Implementierung der vom Interface ActionListener geforderten Methode zur
	 * Reaktion auf ActionEvents.
	 */
	public void actionPerformed(ActionEvent e) {
		...
		case "deleteAccount":
			if (selectedAccount != null) {
				if (JOptionPane.showConfirmDialog(frame,
						"Soll Konto " + kof.getId() + " von " + kuf.getVorname() + " " + kuf.getNachname()
