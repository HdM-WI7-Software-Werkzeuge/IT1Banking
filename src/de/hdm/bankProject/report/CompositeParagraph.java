...
/**
 * Diese Klasse stellt eine Menge einzelner Abs�tze  (<code>SimpleParagraph</code>-Objekte) dar. Diese werden als Unterabschnitte in einem <code>Vector</code> abgelegt verwaltet.
 * @author  Thies
 */
public class CompositeParagraph extends Paragraph {
	 ...
	 */
	private Vector<Paragraph> subParagraphs = new Vector<Paragraph>();
     ...
     * @uml.property  name="subParagraphs"
     */	
	public Vector<Paragraph> getSubParagraphs() {
	...
	public SimpleParagraph getParagraphAt(int i) {
		return (SimpleParagraph)this.subParagraphs.elementAt(i);
	}
	...
	public String toString() {
		...
		for ( int i = 0; i < this.subParagraphs.size(); i++ ) {
			SimpleParagraph p = (SimpleParagraph)this.subParagraphs.elementAt(i);
		...
		/*
		 * Schlie�lich wird der Buffer in einen String umgewandelt und zur�ckgegeben.
		 */		
